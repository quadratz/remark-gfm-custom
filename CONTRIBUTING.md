# Contributing to remark-gfm-custom
...
2. Clone your fork:
   `git clone https://github.com/quadratz/remark-gfm-custom.git`
...
[open an issue](https://github.com/quadratz/remark-gfm-custom/issues/new) for
